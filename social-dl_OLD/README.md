...
| TikTok | ✅ | ✅ | Wasserzeichen-Entfernung |
...
**Instagram-Audio extrahieren:**
```bash
social-dl https://instagram.com/p/...
# → Audio wählen → MP3-Download
```
...
Entwickelt mit ❤️ durch Community-Feedback:
- **Grok** (Basis & Features)
